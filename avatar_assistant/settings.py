...
OPENAI_REQUEST_TIMEOUT_SEC = float(os.getenv("OPENAI_REQUEST_TIMEOUT_SEC", "20"))
...
SARVAM_REQUEST_TIMEOUT_SEC = float(os.getenv("SARVAM_REQUEST_TIMEOUT_SEC", "45"))
...
SADTALKER_PYTHON = os.getenv("SADTALKER_PYTHON", str(BASE_DIR / ".venv" / "Scripts" / "python.exe"))
...
MUSE_TALK_PYTHON = os.getenv("MUSE_TALK_PYTHON", str(BASE_DIR / ".venv" / "Scripts" / "python.exe"))
...
MUSE_TALK_MAX_VRAM_AVATARS = int(os.getenv("MUSE_TALK_MAX_VRAM_AVATARS", "2"))
MUSE_TALK_PRELOAD_GROUPS = os.getenv("MUSE_TALK_PRELOAD_GROUPS", "english,south")
...
AVATAR_NAME_ENGLISH = os.getenv("AVATAR_NAME_ENGLISH", SARVAM_TTS_SPEAKER_ENGLISH.title())
AVATAR_NAME_NORTH = os.getenv("AVATAR_NAME_NORTH", SARVAM_TTS_SPEAKER_NORTH.title())
AVATAR_NAME_SOUTH = os.getenv("AVATAR_NAME_SOUTH", SARVAM_TTS_SPEAKER_SOUTH.title())
